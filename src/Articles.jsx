...
const Articles = ()=>{
    ...
    if(isLoading){
        return(<><h1 className="">Articles</h1>  <div className="d-flex align-items-center m-auto ms-5 justify-content-center mt-5 bs-breakpoint-lg"><h5 className="ml-inline-5 pl-9 topic-selection">Choose Topic:</h5><div className="topic-selection" role="group" aria-label="topic radio toggle button group">
